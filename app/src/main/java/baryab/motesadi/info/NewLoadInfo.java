...
public class NewLoadInfo {
    ...
    public NewLoadInfo(String DraftId, List<PlacesInfo> listOriginPlacesInfo, List<PlacesInfo> listDestinationPlacesInfo, int TruckTypeId, float TruckMinLength,
                       float TruckMaxLength, float TruckMinWidth, float TruckMaxWidth, float TruckMinHeight, float TruckMaxHeight, String ShipmentType, float Weight,
                       int MoneyTypeId, int Money, long LoadDate, String Desc, String Pic, int StoreCost, long disChDate, long expDate, boolean IsGoback, boolean IsAfterRecive, boolean HasTent) {
