...
public class ProfileActivity extends BaseActivity {
    ...
    private void findViews() {
        ivProfileImage = findViewById(R.id.acProfile_ivProfileImage);
        tvFullName = findViewById(R.id.acProfile_tvFullName);
        rbUserRating = findViewById(R.id.acProfile_rbUserRating);
        btnAddNewPhoto = findViewById(R.id.acProfile_btnAddNewPhoto);
        etNationalCode = findViewById(R.id.acProfile_etNationalCode);
        etMobileNumber = findViewById(R.id.acProfile_etMobileNumber);
        etCompanyName = findViewById(R.id.acProfile_etCompanyName);
        etCompanyChairMan = findViewById(R.id.acProfile_etCompanyChairMan);
        etCompanyRegisterationNumber = findViewById(R.id.acProfile_etCompanyRegisterationNumber);
        etCompanyPhoneNumber = findViewById(R.id.acProfile_etCompanyPhoneNumber);
        etCompanyAddress = findViewById(R.id.acProfile_etCompanyAddress);
        btnSave = findViewById(R.id.acProfile_btnSave);
    }
