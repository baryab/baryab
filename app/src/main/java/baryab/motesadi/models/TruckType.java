...
public class TruckType extends SugarRecord {
    ...
    public TruckType(int truckTypeId, String name, int pid, String fullName, float minLength, float maxLength, float minWidth, float maxWidth,
                     float minHeight, float maxHeight, boolean isRoof, boolean hasChild) {
        super();
