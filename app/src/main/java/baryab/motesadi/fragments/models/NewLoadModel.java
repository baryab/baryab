package baryab.motesadi.fragments.models;
...
public class NewLoadModel {
    ...
    public NewLoadModel(List<PlacesInfo> listOriginPlacesInfo, List<PlacesInfo> listDestinationPlacesInfo, int carType, float lengthFrom, float lengthTo, float widthFrom,
                        float widthTo, float heightFrom, float heightTo, String loadingType, int loadingWeight, int loadingFareType, int loadingFare, String description,
                        Base64 loadingPhoto, String warehouseSpending, String expireTime, boolean isShipmentGoingRound, boolean refundAfterArrival, boolean havingWellTent) {
