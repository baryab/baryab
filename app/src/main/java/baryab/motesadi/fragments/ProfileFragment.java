package baryab.motesadi.fragments;
...
import baryab.motesadi.BaseFragment;
...
import baryab.motesadi.dialogs.ConfirmDialog;
...
public class ProfileFragment extends BaseFragment {
    ...
    private void findViews() {
        btnMyProfile = this.rootView.findViewById(R.id.frProfile_btnMyProfile);
        btnShare = this.rootView.findViewById(R.id.frProfile_btnShare);
        btnQuestions = this.rootView.findViewById(R.id.frProfile_btnQuestions);
        btnAboutUs = this.rootView.findViewById(R.id.frProfile_btnAboutUs);
        btnCriticsSuggestions = this.rootView.findViewById(R.id.frProfile_btnCriticsSuggestions);
        btnNotifications = this.rootView.findViewById(R.id.frProfile_btnNotifications);
        btnContactsUs = this.rootView.findViewById(R.id.frProfile_btnContactsUs);
        btnLogout = this.rootView.findViewById(R.id.frProfile_btnLogout);
    }
    ...
    private void setViewsListeners() {
        ...
        btnShare.setOnClickListener(new OnSingleClickListener() {
            @Override
            public void onSingleClick(View v) {
                doShare("سلام. برنامه باریاب نو نسخه متصدیان رو از کافه بازار دانلود کنید. من نصبش کردم و باهاش کار کردم عالی بود فکر کنم بدرد بخوره.");
                doSharting();
            }
        });
