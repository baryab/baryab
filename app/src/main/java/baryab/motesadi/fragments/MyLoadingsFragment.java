...
import baryab.motesadi.adapters.MyLoadingsAdapter;
import baryab.motesadi.info.MyLoadingInfo;
import baryab.motesadi.interfaces.OnLoadMoreListener;
...
public class MyLoadingsFragment extends BaseFragment {
    ...
    public static MyLoadingsFragment newInstance() {
        Bundle args = new Bundle();
        MyLoadingsFragment fragment = new MyLoadingsFragment();
...
//        getMyLoadingsFromServer();
    ...
    private void findViews() {
        rlNoItemFound = this.rootView.findViewById(R.id.frMyLoadings_rlNoItemFound);
        swipeContainer = this.rootView.findViewById(R.id.frMyLoadings_swipeContainer);
        rvMyLoadings = this.rootView.findViewById(R.id.frMyLoadings_rvMyLoadings);
    }
